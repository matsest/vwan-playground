...
resource noneRouteTable 'Microsoft.Network/virtualHubs/hubRouteTables@2021-03-01' existing = {
  name: 'None'
  parent: vHub
}

resource defaultRouteTable 'Microsoft.Network/virtualHubs/hubRouteTables@2021-03-01' existing = {
